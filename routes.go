...
func SetupRoutes(app *fiber.App) {
	...
	app.Patch("/api/v1/transaction-type/:id", handlers.UpdateTransactionType)
	...
	app.Patch("/api/v1/coin-type/:id", handlers.UpdateCoinType)
	...
	app.Patch("/api/v1/exchange-rate/:id", handlers.UpdateExchangeRate)
	...
	app.Patch("/api/v1/user/:id", handlers.UpdateUser)
	...
	app.Patch("/api/v1/product/:id", handlers.UpdateProduct)
	...
	app.Patch("/api/v1/balance/:id", handlers.UpdateUserBalance)
	...
	app.Patch("/api/v1/transaction/:id", handlers.UpdateTransaction)
